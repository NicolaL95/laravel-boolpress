...
<form action="{{route('admin.post.update',$post->slug)}}" method="post">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="title" id="title" class="form-control @error ('title') is_invalid @enderror" placeholder="write your title..." aria-describedby="TitleHelper" value="{{old('title')}}">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="subtitle" id="subtitle" class="form-control @error ('subtitle') is_invalid @enderror" placeholder="write your subtitle..." aria-describedby="SubTitleHelper" value="{{old('subtitle')}}">
